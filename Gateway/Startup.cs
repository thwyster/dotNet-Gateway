...
namespace Gateway
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            //Esta linha sempre deve ser a última do método configure: 
            //Pois o middleware do Ocelot é terminal.Ou seja, ele não invoca nenhum outro middleware do pipeline.Caso a solicitação realizada não seja encontrada nas configurações do Ocelot, ele gera um erro 404.
            //teste
            app.UseOcelot().Wait();
        }
    }
